...
3. Programatic Access(AWS_ACCESS_KEY_ID & AWS_SECRET_ACCESS_KEY) or *SSO details* of the AWS account with Administrator or Power User Role
...
There are two ways you can authenticate with AWS Account:
...
Secret access key: examplesecret123/K7MDSECRETENG/bPxRfiCYEXAMPLEKEY
----
...
b) Using Single Sign On (SSO) for AWS, If your organization supports this:
[.shell]
----
...
CLI default client Region [ap-southeast-1]: <Enter>
