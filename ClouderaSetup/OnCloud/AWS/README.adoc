...
If you are unsure about the steps or don’t have a registered domain or hosted zone set up on `AWS Route53`, refer to the guide link:https://github.com/cloudera/cloudera-partners/blob/keycloak-ssl-le/ClouderaSetup/OnCloud/AWS/Route53.adoc[**here**] for detailed instructions.
====
...
Secured HTTPS URL: **https://<WorkshopName.Domain>/realms/master/protocol/saml/clients/cdp-sso**

**The Link for SSO to `KeyCloak` Server WebUI for Workshop Owners (Admin User):**

Keycloak URL: **http://<KeyCloak_Server_IP>/ **

Secured HTTPS URL: **https://<WorkshopName.Domain>/**
