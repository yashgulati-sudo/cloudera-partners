...
---
[NOTE]
**Below are the optional parameters that should only be changed if customization is needed. If you intend to proceed with the default configuration of the data services, do not modify the values. If you need to make changes, please refer to the table below for detailed instructions on providing the correct values.**
...
|Default value is **xsmall**. If you want to override, replace the value with one of the given possible values. 
...
|Default value is **m5.2xlarge**. If you want to override, replace the value with one of the CDE supported AWS instance types. Regarding supported instance types, kindly refer official documentation. 

No quotes, only string
|CDE_MIN_INSTANCES
|Possible values: **0** to **100**.
|Default value is **10**. If you want to override, replace the value with any number between the given possible range.

No quotes, only integer
|CDE_MAX_INSTANCES
|Possible values: **0** to **100**.
|Default value is **40**. If you want to override, replace the value with any number between the given possible range.

No quotes, only integer
|CDE_SPARK_VERSION
|Possible values: **SPARK2, SPARK2_4, SPARK3, SPARK3_0, SPARK3_1, SPARK3_2, SPARK3_3, SPARK3_5**
|Default value is **SPARK3**. If you want to override, replace the value with one of the given possible values.
