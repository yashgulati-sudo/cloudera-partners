...
image::build/images/profile.png[profile, 180, 120]

image::build/images/profile_1.png[profile1, 290, 193]

* Click on Generate Access Key as shown below.

image::build/images/gen_access_key.png[access_key, 600, 400]
...
image::build/images/gen_access_key_1.png[access_key1, 300, 200]
...
8. AWS components related to the deployment are also destroyed(e.g bucket, roles, policies etc.)
9. Users
10. Keycloak Server
