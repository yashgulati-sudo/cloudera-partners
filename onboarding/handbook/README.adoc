...
* <<preface, 1. PREFACE>>
* <<2-how-to-become-a-cloudera-partner, 2. HOW TO BECOME A CLOUDERA PARTNER?>>
** <<21-become-a-cloudera-partner, 2.1 Become a Cloudera Partner>>
** <<22-already-a-partner-register-your-username, 2.2 Already a Partner? Register your username>>
** <<accessing-the-partner-portal, 2.3 Accessing the Partner Portal>>
* <<3-trainings-accreditation--certifications, 3. TRAININGS, ACCREDITATION & CERTIFICATIONS>>
** <<31-cloudera-technical-accreditation-program, 3.1 Cloudera Technical Accreditation Program>>
...
** <<4-cdp-partner-developer-license, 4. CDP Partner Developer License>>
** <<5-cloudera-on-boarding---cloud, 5. CLOUDERA ON-BOARDING - CLOUD>>
*** <<aws, 5.1 AWS>>
*** <<azure, 5.2 AZURE>>
*** <<gcp, 5.3 GCP>>
** <<6-cloudera-on-boarding---on-prem, 6. CLOUDERA ON-BOARDING - ON-PREM>>
* <<7-live-on-demand-sessions, 7. LIVE ON-DEMAND SESSIONS>>
